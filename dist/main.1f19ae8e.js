...
jQuery('.test').addClass('red').addClass('blue'); //jquery 不返回 elements , 返回的是 api 对象
...
var api1 = jQuery('.test1');
var api2 = api1.find('.child').addClass('red').addClass('green'); //jQuery('.test1').find('.child').addClass('red').addClass('green');

var oldApi = api2.end().addClass('yellow');
var x = jQuery('.test2').find('.child');
x.each(function (div) {
