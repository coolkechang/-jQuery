...
window.$ = window.jQuery = function (selectorOrArray) {
  ...
  var api = Object.create(jQuery.prototype); //创建一个对象，这个对象的 __proto__ 为括号里的东西
...
jQuery.fn = jQuery.prototype = {
  ...
  constructor: jQuery,
  //写这句话是因为：jQuery.prototype 一开始就有 constructor 属性，不写这句话会被覆盖
  ...
  find: function find(selector) {
    ...
    for (var i = 0; i < this.elements.length; i++) {
      var element2 = Array.from(this.elements[i].querySelectorAll(selector));
...
},{}]},{},["../../../../../../AppData/Local/Yarn/Data/global/node_modules/parcel/src/builtins/hmr-runtime.js","jquery2.js"], null)
